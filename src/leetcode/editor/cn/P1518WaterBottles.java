...
public class P1518WaterBottles {
    ...
    class Solution {
        ...
        private int numWaterBottles(int numBottles, int numExchange, int leftBottles) {
            if (numBottles + leftBottles < numExchange) return numBottles;
            return numBottles + numWaterBottles((numBottles + leftBottles) / numExchange, numExchange, (numBottles + leftBottles) % numExchange);
        }
    }
